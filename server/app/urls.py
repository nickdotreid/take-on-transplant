...
urlpatterns = [
    ...
    path('stories/<patient_id>/story/<story_id>/', PatientStoryTableOfContentsView.as_view(), name='patient-story'),
    path('stories/<patient_id>/', PatientStoryTableOfContentsView.as_view(), name='patient-story'),
